              ...
              <TabsContent value="login">
                <form onSubmit={handleLogin} className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <Button type="button" variant="outline" className="gap-2" onClick={() => { /* Google auth placeholder */ }}>
                    ...
                    <Button type="button" variant="outline" className="gap-2" onClick={() => { /* Facebook auth placeholder */ }}>
