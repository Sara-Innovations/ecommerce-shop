      ...
      {carousel ? (
        <div className="relative">
          ...
          <div
            ...
            className="flex gap-3 sm:gap-4 overflow-x-auto scrollbar-hide scroll-smooth pb-4 snap-x snap-mandatory touch-pan-x items-stretch"
            style={{ scrollSnapType: 'x mandatory', scrollBehavior: 'smooth' }}
          >
            {products.map((product) => (
              <div
                key={product.id}
                className="flex-shrink-0 snap-center w-[calc(50%-6px)] sm:w-[calc(33.333%-11px)] lg:w-[calc(25%-12px)]"
